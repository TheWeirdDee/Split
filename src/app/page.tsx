...
const Button = ({ children, variant = "primary", className = "", ...props }: any) => {
  const baseStyles = "px-6 py-2.5 rounded-full font-semibold text-[15px] transition-all active:scale-95 flex items-center justify-center gap-2";
  const variants = {
    ...
    <div className="bg-[#0a0a0a] text-[#f5f0e8] font-body selection:bg-[#00c896] selection:text-black overflow-x-hidden">
      ...
      <section ref={heroRef} className="relative min-h-[100svh] flex flex-col justify-center pt-[125px] pb-10 px-12 max-w-[1280px] mx-auto overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 pointer-events-none">
          ...
          <div className="absolute inset-0 opacity-[0.12]" 
               style={{ 
                 backgroundImage: 'radial-gradient(rgba(0,200,150,0.3) 0.5px, transparent 0.5px)', 
        ...
        <div className="relative z-10 w-full grid lg:grid-cols-[1.22fr_0.78fr] gap-12 items-center">
          ...
          <div className="flex flex-col items-start">
            ...
            <h1 className="hero-h1 clash-display font-bold text-[clamp(40px,5.8vw,68px)] leading-[0.95] tracking-[-0.04em] mb-6 flex flex-col">
              ...
              <span className="text-[#f5f0e8]">No awkwardness.</span>
            </h1>
            ...
            <div className="hero-cta flex flex-wrap gap-3">
              <Link href="/app">
                <Button className="px-[30px] py-[14px]">Open App →</Button>
              </Link>
              <Link href="#how-it-works">
                <Button variant="outline" className="px-[30px] py-[14px]">See how it works ↓</Button>
              </Link>
            </div>
      ...
      <section id="features" className="bg-[#141414] py-32 px-8">
        <div className="max-w-[1280px] mx-auto">
          ...
          <div className="features-grid grid md:grid-cols-3 gap-4 mt-[60px]">
             {/* Card 1 */}
             <div className="feature-card bg-[#0a0a0a] border border-[#242424] rounded-[20px] p-[32px] transition-all hover:border-[#00c896] hover:shadow-[0_0_30px_rgba(0,200,150,0.1)] hover:-translate-y-1 group">
               <div className="w-[44px] h-[44px] bg-[rgba(0,200,150,0.08)] rounded-[10px] flex items-center justify-center text-[20px] group-hover:scale-110 transition-transform">⚡</div>
               <h3 className="clash-display font-bold text-[18px] text-[#f5f0e8] mt-5 mb-2">Instant Settlement</h3>
               <p className="dm-sans text-[14px] text-[#7a7a7a] leading-[1.6]">Pay with cUSD the moment debts are calculated. No waiting, no transfers, no banks.</p>
             </div>
             {/* Card 2 */}
             <div className="feature-card bg-[#0a0a0a] border border-[#242424] rounded-[20px] p-[32px] transition-all hover:border-[#00c896] hover:shadow-[0_0_30px_rgba(0,200,150,0.1)] hover:-translate-y-1 group">
               <div className="w-[44px] h-[44px] bg-[rgba(0,200,150,0.08)] rounded-[10px] flex items-center justify-center text-[20px] group-hover:scale-110 transition-transform">🧮</div>
               <h3 className="clash-display font-bold text-[18px] text-[#f5f0e8] mt-5 mb-2">Smart Debt Engine</h3>
               <p className="dm-sans text-[14px] text-[#7a7a7a] leading-[1.6]">We minimize transactions needed. More efficiency, less hassle.</p>
             </div>
             {/* Card 3 */}
             <div className="feature-card bg-[#0a0a0a] border border-[#242424] rounded-[20px] p-[32px] transition-all hover:border-[#00c896] hover:shadow-[0_0_30px_rgba(0,200,150,0.1)] hover:-translate-y-1 group">
               <div className="w-[44px] h-[44px] bg-[rgba(0,200,150,0.08)] rounded-[10px] flex items-center justify-center text-[20px] group-hover:scale-110 transition-transform">👥</div>
               <h3 className="clash-display font-bold text-[18px] text-[#f5f0e8] mt-5 mb-2">Group Management</h3>
               <p className="dm-sans text-[14px] text-[#7a7a7a] leading-[1.6]">Create a group in 10 seconds. Share via WhatsApp or QR code.</p>
             </div>
             {/* Card 4 */}
             <div className="feature-card bg-[#0a0a0a] border border-[#242424] rounded-[20px] p-[32px] transition-all hover:border-[#00c896] hover:shadow-[0_0_30px_rgba(0,200,150,0.1)] hover:-translate-y-1 group">
               <div className="w-[44px] h-[44px] bg-[rgba(0,200,150,0.08)] rounded-[10px] flex items-center justify-center text-[20px] group-hover:scale-110 transition-transform">🔗</div>
               <h3 className="clash-display font-bold text-[18px] text-[#f5f0e8] mt-5 mb-2">On-Chain Proof</h3>
               <p className="dm-sans text-[14px] text-[#7a7a7a] leading-[1.6]">Every payment is a blockchain transaction. Transparent and permanent.</p>
             </div>
             {/* Card 5 */}
             <div className="feature-card bg-[#0a0a0a] border border-[#242424] rounded-[20px] p-[32px] transition-all hover:border-[#00c896] hover:shadow-[0_0_30px_rgba(0,200,150,0.1)] hover:-translate-y-1 group">
               <div className="w-[44px] h-[44px] bg-[rgba(0,200,150,0.08)] rounded-[10px] flex items-center justify-center text-[20px] group-hover:scale-110 transition-transform">📱</div>
               <h3 className="clash-display font-bold text-[18px] text-[#f5f0e8] mt-5 mb-2">MiniPay Native</h3>
               <p className="dm-sans text-[14px] text-[#7a7a7a] leading-[1.6]">Built for MiniPay. No extra apps, no new wallets. Use what you already have.</p>
             </div>
             {/* Card 6 */}
             <div className="feature-card bg-[#0a0a0a] border border-[#242424] rounded-[20px] p-[32px] transition-all hover:border-[#00c896] hover:shadow-[0_0_30px_rgba(0,200,150,0.1)] hover:-translate-y-1 group">
               <div className="w-[44px] h-[44px] bg-[rgba(0,200,150,0.08)] rounded-[10px] flex items-center justify-center text-[20px] group-hover:scale-110 transition-transform">🌍</div>
               <h3 className="clash-display font-bold text-[18px] text-[#f5f0e8] mt-5 mb-2">African-First</h3>
               <p className="dm-sans text-[14px] text-[#7a7a7a] leading-[1.6]">Designed for the way we split money here. Rent, chop money, events, and more.</p>
             </div>
          </div>
        </div>
      </section>
      ...
      <section ref={siaWrapperRef} className="see-in-action-wrapper relative bg-[#0a0a0a]">
        <div ref={siaStickyRef} className="see-in-action-sticky w-full min-h-screen flex flex-col items-center justify-center overflow-hidden bg-[#0a0a0a]">
          <div className="text-center z-50">
            <h2 className="clash-display font-bold text-3xl text-[#f5f0e8] mt-20">How Split works.</h2>
            <div className="flex flex-wrap gap-3 justify-center relative top-10">
          ...
          <div className="relative w-full max-w-[960px] px-6 h-[320px] mt-1">
            ...
            <div className="absolute inset-0 bg-[#141414] border border-[#242424] md:rounded-[32px] rounded-0 p-8 shadow-2xl flex items-center justify-center">
              ...
              <div className="sia-state-1 absolute inset-0 p-8 flex flex-col items-center justify-center text-center space-y-6 w-full transition-all z-10">
                <div className="w-20 h-20 bg-[#0c1a16] border border-[#00c89633] rounded-2xl flex items-center justify-center text-4xl shadow-inner group">
                   <span className="group-hover:scale-110 transition-transform">✈️</span>
                </div>
                <div className="space-y-4 w-full max-w-xs">
                  <h3 className="clash-display font-bold text-2xl text-[#f5f0e8]">Name your group</h3>
                  <div className="bg-[#0c1a16] border-2 border-dashed border-[#00c89633] p-4 rounded-xl flex items-center justify-center gap-3 group cursor-pointer hover:border-[#00c89688] transition-all">
                  ...
                  <p className="text-[#7a7a7a] text-xs">Pick an emoji and set a goal.</p>
                </div>
              </div>
      ...
      <section className="px-8 py-20 reveal">
        <div className="max-w-[1100px] mx-auto bg-[#00c896] rounded-[40px] p-12 md:p-24 text-center space-y-10 relative overflow-hidden">
          ...
          <div className="relative z-10 space-y-6">
            <span className="dm-mono text-xs font-bold tracking-[0.2em] text-black/60 uppercase">READY TO SPLIT?</span>
            <h2 className="clash-display font-bold text-[clamp(48px,7vw,88px)] text-black leading-[1.05] max-w-2xl mx-auto">Stop chasing people<br />for money.</h2>
            <p className="dm-sans text-black/70 text-[18px] font-medium max-w-xl mx-auto leading-relaxed">The simplest way to handle group expenses. Instant settlements, zero awkward conversations.</p>
          </div>
          <div className="relative z-10 flex flex-col items-center gap-10">
            <Link href="/app"><Button className="bg-black text-[#00c896] px-[36px] py-[16px] text-[16px] font-bold hover:bg-black/85 hover:scale-105">Open Split →</Button></Link>
            <div className="flex flex-col items-center gap-4">
               <div className="bg-white p-3 rounded-2xl shadow-2xl"><QRCodeSVG value="https://split-five-eta.vercel.app" size={120} /></div>
               <span className="dm-mono text-[11px] text-black/50 tracking-widest uppercase">Scan to open in MiniPay</span>
            </div>
          </div>
        </div>
      </section>
