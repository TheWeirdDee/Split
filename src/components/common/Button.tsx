...
/**
 * Shared button with style variants, sizes, and a built-in loading spinner.
 * While `loading` it is disabled and reports `aria-busy` to assistive tech; the
 * spinner itself is `aria-hidden` so it isn't announced.
 */
export const Button = ({
  className,
  variant = 'primary',
