    ...
    <section ref={wrapperRef} className="see-in-action-wrapper relative bg-[#0a0a0a]">
      <div ref={stickyRef} className="see-in-action-sticky w-full min-h-screen flex flex-col items-center justify-center overflow-hidden bg-[#0a0a0a]">
        <div className="text-center z-50">
          <h2 className="clash-display font-bold text-3xl text-[#f5f0e8] mt-10 mb-3">How Split & Save works.</h2>
          <div className="flex flex-wrap gap-3 justify-center mt-8">
             <span className="sia-indicator-1 dm-mono text-[10px] px-5 py-2 rounded-full border border-[#00C896] text-[#00C896] bg-[rgba(0,200,150,0.08)]">01 CREATE</span>
             <span className="sia-indicator-2 dm-mono text-[10px] px-5 py-2 rounded-full border border-[#242424] text-[#3a3a3a]">02 LAUNCH</span>
             <span className="sia-indicator-3 dm-mono text-[10px] px-5 py-2 rounded-full border border-[#242424] text-[#3a3a3a]">03 LOG & SAVE</span>
             <span className="sia-indicator-4 dm-mono text-[10px] px-5 py-2 rounded-full border border-[#242424] text-[#3a3a3a]">04 SETTLE & CASHOUT</span>
          </div>
        </div>
          ...
          <div className="absolute inset-0 bg-[#141414] border border-[#242424] md:rounded-[32px] rounded-0 p-8 shadow-2xl flex items-center justify-center">
            ...
            <div className="sia-state-1 absolute inset-0 p-8 flex flex-col items-center justify-center text-center space-y-6 w-full transition-all z-10">
              ...
              <div className="space-y-2 w-full max-w-lg">
                <h3 className="clash-display font-bold text-2xl text-[#f5f0e8]">Create a Group or Circle</h3>
                <p className="text-[#8A8A8A] text-sm leading-relaxed mx-auto max-w-md">
                  Set up in seconds. Create an expense split group or a collaborative savings circle, then share the invite link or QR code.
                </p>
              </div>
              ...
              <div className="bg-[#0c1a16] border-2 border-dashed border-[#00c89633] p-3 rounded-xl flex items-center justify-center gap-3 group cursor-pointer hover:border-[#00c89688] transition-all w-full max-w-xs">
                ...
                <span className="dm-sans font-bold text-[#00c896] tracking-tight">Create Group or Circle</span>
              </div>
            </div>
            ...
            <div className="sia-state-2 absolute inset-0 p-12 flex flex-col items-center justify-center text-center space-y-8 opacity-0 pointer-events-none">
              ...
              <div className="space-y-6 w-full max-w-xs">
                 <h3 className="clash-display font-bold text-2xl">Launch Onchain</h3>
                 ...
                 <p className="text-[#7a7a7a] text-xs">Setting up your smart contract on Celo. Transparent and secure.</p>
              </div>
            </div>

            {/* State 3: Track */}
            <div className="sia-state-3 absolute inset-0 p-12 flex flex-col items-center justify-center text-center space-y-6 opacity-0 pointer-events-none">
              <div className="w-full space-y-3">
                <div className="bg-[#0a0a0a] border border-[#242424] p-4 rounded-2xl flex justify-between items-center group hover:border-[#00c896]/50 transition-colors">
                  <div className="flex items-center gap-3">
                     ...
                     <div className="text-left"><p className="text-sm font-bold">Sarah logged expense</p><p className="text-[10px] text-[#3a3a3a]">$120 for Dinner</p></div>
                  </div>
                  <span className="text-[10px] font-mono text-[#00c896]">EXPENSE</span>
                </div>
                <div className="bg-[#0a0a0a] border border-[#242424] p-4 rounded-2xl flex justify-between items-center group hover:border-[#00c896]/50 transition-colors">
                  <div className="flex items-center gap-3">
              ...
              <div className="space-y-1">
                 <h3 className="clash-display font-bold text-xl">Log Expenses & Save</h3>
                 <p className="text-[#7a7a7a] text-xs">No manual math or tracking overhead. Split & Save ledger keeps it in sync.</p>
              </div>
            </div>
            ...
            <div className="sia-state-4 absolute inset-0 p-12 flex flex-col items-center justify-center text-center space-y-8 opacity-0 pointer-events-none">
              ...
              <div className="w-full space-y-4">
                <div className="w-full py-5 bg-[#00C896] text-black font-bold rounded-2xl text-sm shadow-xl shadow-[#00C896]/20 hover:scale-[1.02] transition-transform cursor-pointer">Settle Up or Cash Out</div>
                <p className="dm-mono text-[9px] text-[#3a3a3a]">SECURE CELO ONCHAIN CASHOUT</p>
              </div>
            </div>
